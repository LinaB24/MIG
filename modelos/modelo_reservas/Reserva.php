    ...
    public function guardar($data)
{
    ...
    $sqlCheck = "SELECT COUNT(*) FROM reservas WHERE mesa_id = ? AND fecha = ? AND hora = ?";
    $stmtCheck = $this->db->prepare($sqlCheck);
    $stmtCheck->execute([$data['mesa_id'], $data['fecha'], $data['hora']]);
    ...
    // Si no existe, guardar la reserva
