...
class ReservaController
{
    ...
    public function guardar()
    {
        ...
        // Verificar si ya existe una reserva en la misma mesa, fecha y hora
    ...
    public function actualizar()
    {
        ...
        // Verificar si ya existe una reserva en la misma mesa, fecha y hora (excepto la actual)
        $sqlCheck = "SELECT COUNT(*) FROM reservas WHERE mesa_id = ? AND fecha = ? AND hora = ? AND id != ?";
        $stmtCheck = $this->modelo->db->prepare($sqlCheck);
        $stmtCheck->execute([$datos['mesa_id'], $datos['fecha'], $datos['hora'], $datos['id']]);
