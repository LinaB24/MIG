...
<div class="container mt-5">
    <h2>Editar Pedido</h2>
   <form method="POST" action="/aaaaa/controllers/pedidosControllers.php?accion=actualizar">
    ...
    <input type="hidden" name="pedido_id" value="<?= $pedido['PedidoID'] ?>">
        ...
        <a href="/aaaaa/controllers/pedidosControllers.php?accion=crear" class="btn btn-secondary ms-2">Cancelar</a>
