...
<form action="/aaaaa/controllers/pedidosControllers.php?accion=guardar" method="POST">
    ...
    <a href="/aaaaa/views/pedidos/listar_pedidos.php" class="btn btn-ver">Ver Pedidos</a>
    <a href="/aaaaa/controllers/pedidosControllers.php?accion=crear" class="btn btn-secondary">Cancelar</a>
